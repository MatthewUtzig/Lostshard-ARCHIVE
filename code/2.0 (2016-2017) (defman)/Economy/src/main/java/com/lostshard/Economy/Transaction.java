...
@Embeddable
@Immutable
public class Transaction extends Number implements Comparable<Transaction> {
	...
	public Transaction(Wallet from, Wallet to, int value, String note) {
	...
	@Override
	public int compareTo(Transaction gc) {
