...
public class SPL_ClearSky extends Spell {
	private static final String 	_name = "Clear Sky";
	private static final String 	_spellWords = "Precipitous Quititus";
	private static final int 		_castingDelay = 0;
	private static final int 		_cooldownTicks = 20;
	private static final int		_manaCost = 0;
	private static final int[]		_reagentCost = {295,331};
	...
	public void doAction(Player player) {
		if(!RPG._castingClearSkyPlayers.contains(player.getName())) {
			Output.positiveMessage(player, "You begin chanelling Clear Sky...");
			RPG._castingClearSkyPlayers.add(player.getName());
			PseudoPlayer pseudoPlayer = PseudoPlayerHandler.getPseudoPlayer(player.getName());
			pseudoPlayer._isCastingClearSky = true;
