...
public class SPL_Dispell extends Spell {
	private static final String 	_name = "Dispell";
	private static final String 	_spellWords = "Wizardus Leavicus";
	...
	public void doAction(Player player) {
		...
		if(_playerFound != null) {
			...
			_playerFound.setHealth(damag.getHealth()+8);
			if(damag.getHealth() > 20)
				_playerFound.setHealth(20);
		}
