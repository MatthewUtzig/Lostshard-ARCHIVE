...
public class MiningSkill extends Skill {
	...
	public static void onBlockBreak(BlockBreakEvent event) {
		...
		if (block.getType().equals(Material.STONE) && ItemUtils.isPickAxe(player.getItemInHand())
			...
			if (Math.random() < chanceOfDrop) {
				...
				if (coaldroprate > itemSelect)
					...
					block.getWorld().dropItemNaturally(block.getLocation(), new ItemStack(Material.COAL_ORE, 1));
					...
					block.getWorld().dropItemNaturally(block.getLocation(), new ItemStack(Material.REDSTONE_ORE, 1));
					...
					block.getWorld().dropItemNaturally(block.getLocation(), new ItemStack(Material.LAPIS_ORE, 1));
					...
					block.getWorld().dropItemNaturally(block.getLocation(), new ItemStack(Material.EMERALD_ORE, 1));
