...
public class SPL_SummonFireElemental extends Spell {
	private static final String 	_name = "Summon Fire Elemental";
	private static final String 	_spellWords = "Flamus Monstricus"; // Magickus Tradjicus
	private static final int 		_castingDelay = 0;
	private static final int 		_cooldownTicks = 20;
	private static final int		_manaCost = 75;
	...
	public void doAction(Player player) {
		...
		LivingEntity lE = player.getWorld().spawnCreature(loc, creatureType);//.dropItem(_blockFound.getLocation(), new ItemStack(itemToGive, 1));
		RPG._summondMobsOwnerHashSet.put(lE.getEntityId(), player.getName());
	}
}
