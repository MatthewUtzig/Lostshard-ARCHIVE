...
public class SPL_DRG_Grief extends Spell {
	private static final String 	_name = "Grief";
	private static final String 	_spellWords = "Gahahahah lol";
	private static final int 		_castingDelay = 0;
	private static final int 		_cooldownTicks = 20;
	private static final int		_manaCost = 5;
	private static final int[]		_reagentCost = {331,122};
	private static final int 		_minMagery = 100;
