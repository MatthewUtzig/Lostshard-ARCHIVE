...
public class Database {
	...
	public static void deleteScroll(Scroll scroll, int playerID) {
		...
		try {
			Connection conn = connPool.getConnection();
			PreparedStatement prep = conn
					.prepareStatement("DELETE FROM scrolls WHERE playerid=? AND scroll=? LIMIT 1;", Statement.RETURN_GENERATED_KEYS);
	...
	public static void insertBuild(Build build, int playerID) {
		try {
			Connection conn = connPool.getConnection();
			PreparedStatement prep = conn.prepareStatement("INSERT IGNORE INTO builds (playerid) VALUES (?);", Statement.RETURN_GENERATED_KEYS);
				prep.setInt(1, playerID);
			prep.execute();
	...
	public static void insertClan(Clan clan) {
		try {
			Connection conn = connPool.getConnection();
			PreparedStatement prep = conn
					.prepareStatement("INSERT IGNORE INTO clans (name,owner,leaders,members,invited) VALUES (?,?,?,?,?);", Statement.RETURN_GENERATED_KEYS);
	...
	public static void insertNPC(NPC npc) {
		try {
			Connection conn = connPool.getConnection();
			PreparedStatement prep = conn
					.prepareStatement("INSERT IGNORE INTO npcs (name,location,type,plotId) VALUES (?,?,?,?);", Statement.RETURN_GENERATED_KEYS);
	...
	public static int insertPermanentGate(PermanentGate gate) {
		...
		try {
			Connection conn = connPool.getConnection();
			PreparedStatement prep = conn
					.prepareStatement("INSERT IGNORE INTO permanentgates (fromLocation, toLocation, creator, direction) VALUES (?,?,?,?);", Statement.RETURN_GENERATED_KEYS);
		...
		try {
			...
			PreparedStatement prep = conn
					.prepareStatement("INSERT IGNORE INTO players "
							+ "(uuid,bank,titles,spellbook,ignored) VALUES (?,?,?,?,?)", Statement.RETURN_GENERATED_KEYS);
		...
		try {
			...
			PreparedStatement prep = conn
					.prepareStatement("INSERT IGNORE INTO plots "
							...
							+ "capturePoint,allowMagic,allowPvp,friends,coowners) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", Statement.RETURN_GENERATED_KEYS);
	...
	public static int insertRune(int playerID, String response, Location markLoc) {
		...
		try {
			Connection conn = connPool.getConnection();
			PreparedStatement prep = conn
					.prepareStatement("INSERT IGNORE INTO runes (location, label, playerid) VALUES (?,?,?);", Statement.RETURN_GENERATED_KEYS);
	...
	public static void insertStore(Store store) {
		try {
			Connection conn = connPool.getConnection();
			PreparedStatement prep = conn
					.prepareStatement("INSERT IGNORE INTO stores (npcId,content) VALUES (?,?);", Statement.RETURN_GENERATED_KEYS);
