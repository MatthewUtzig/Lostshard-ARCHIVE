...
public class DeathHandler {
	...
	public static void handleDeath(EntityDeathEvent event) {
		...
		// double distance = Utils.distance(player.getLocation(),
		// entity.getLocation());
		...
		//
		// PseudoPlayer killerPseudoPlayer =
		// PseudoPlayerHandler.getPlayer(closestPlayer);
		...
		// int createdScrollId = Database.addScroll(killerPseudoPlayer.getId(),
		// droppedSpell);
		...
		// Output.positiveMessage(closestPlayer,
		// "The Ender Dragon dropped a scroll of "+droppedSpell.getName()+".");
		// }
		...
		// int numArrows =
		// _livingEntityArrowHitHashMap.get(entity.getEntityId());
		// for(int i=0; i<numArrows; i++) {
		// entity.getWorld().dropItemNaturally(entity.getLocation(), new
		// ItemStack(Material.ARROW, 1));
		// }
		// _livingEntityArrowHitHashMap.remove(entity.getEntityId());
		// }

		// if(entity instanceof Monster || entity instanceof Giant || entity
		// instanceof Ghast || entity instanceof PigZombie) {
		// if(RPG._worldEvent != null && RPG._worldEvent instanceof
		// GhastAttackEvent && entity instanceof Ghast) {
		...
		// if(randInt == 0)
		// entity.getLocation().getWorld().dropItemNaturally(entity.getLocation(),
		// new ItemStack(Material.GOLD_SWORD.getId(), 1));
		// else if(randInt == 1)
		// entity.getLocation().getWorld().dropItemNaturally(entity.getLocation(),
		// new ItemStack(Material.GOLD_HOE.getId(), 1));
		// else if(randInt == 2)
		// entity.getLocation().getWorld().dropItemNaturally(entity.getLocation(),
		// new ItemStack(Material.GOLD_PICKAXE.getId(), 1));
		// else if(randInt == 3)
		// entity.getLocation().getWorld().dropItemNaturally(entity.getLocation(),
		// new ItemStack(Material.GOLD_AXE.getId(), 1));
		// else if(randInt == 4)
		// entity.getLocation().getWorld().dropItemNaturally(entity.getLocation(),
		// new ItemStack(Material.GOLD_SPADE.getId(), 1));
		// else if(randInt == 5)
		// entity.getLocation().getWorld().dropItemNaturally(entity.getLocation(),
		// new ItemStack(Material.WATCH.getId(), 1));
		// else if(randInt == 6)
		// entity.getLocation().getWorld().dropItemNaturally(entity.getLocation(),
		// new ItemStack(Material.GOLD_INGOT.getId(), 1));
		// else if(randInt == 7)
		// entity.getLocation().getWorld().dropItemNaturally(entity.getLocation(),
		// new ItemStack(Material.POWERED_RAIL.getId(), 3));
		// else if(randInt == 8)
		// entity.getLocation().getWorld().dropItemNaturally(entity.getLocation(),
		// new ItemStack(Material.GOLDEN_APPLE.getId(), 3));
		// else if(randInt == 9)
		// entity.getLocation().getWorld().dropItemNaturally(entity.getLocation(),
		// new ItemStack(Material.GOLD_HELMET.getId(), 1));
		// else if(randInt == 10)
		// entity.getLocation().getWorld().dropItemNaturally(entity.getLocation(),
		// new ItemStack(Material.GOLD_CHESTPLATE.getId(), 1));
		// else if(randInt == 11)
		// entity.getLocation().getWorld().dropItemNaturally(entity.getLocation(),
		// new ItemStack(Material.GOLD_LEGGINGS.getId(), 1));
		// else if(randInt == 12)
		// entity.getLocation().getWorld().dropItemNaturally(entity.getLocation(),
		// new ItemStack(Material.GOLD_BOOTS.getId(), 1));
		// }
		// }
		// monster died
		...
		// PseudoPlayer pseudoPlayerDamager =
		// PseudoPlayerHandler.getPlayer(lastAttackerPlayer);
		// Survivalism.possibleSkillGain(lastAttackerPlayer,
		// pseudoPlayerDamager);
		...
		// }
		//
		// int createdScrollId = Database.addScroll(pseudoPlayerDamager.getId(),
		// droppedScroll);
		// if(createdScrollId != -1) {
		// pseudoPlayerDamager.addScroll(droppedScroll);
		// Database.updatePlayerByPseudoPlayer(pseudoPlayerDamager);
		// Output.positiveMessage(lastAttackerPlayer,
		// "The Ghast dropped a scroll of "+droppedScroll.getName()+".");
		// }
		// else System.out.println("ERROR: got -1 from database.addscroll");
		// }
		// }
		// else if(rand < .2 || entity instanceof Giant || entity instanceof
		// EnderDragon) {
		...
		// Database.updatePlayerByPseudoPlayer(pseudoPlayerDamager);
		// Output.positiveMessage(lastAttackerPlayer,
		// "The "+monsterName+" dropped a scroll of "+droppedSpell.getName()+".");
		// }
		// else System.out.println("ERROR: got -1 from database.addscroll");
		// }
		// }
		...
		/*
		 * if(entity instanceof PigZombie) { if(Math.random() < .02) { if( } }
		 */
