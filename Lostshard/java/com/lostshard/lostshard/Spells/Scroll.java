...
public enum Scroll {
	...
	TELEPORT("Teleport","Nearius Porticus",3,20,5,0,new ItemStack[] {new ItemStack(Material.FEATHER)}), 
	...
	CREATEFOOD("Createfood","Magickus Delicious",2,10,5,0,new ItemStack[] {new ItemStack(Material.SEEDS)}),
