...
public class BanHandler {
	...
	public static Ban banPlayer(OfflinePlayer player, Player by, long timeLength, String reason) {
		Ban ban = null;
		ban = new Ban(player.getUniqueId(), timeLength, reason, by == null ? null : by.getUniqueId());
		return ban;
	}
