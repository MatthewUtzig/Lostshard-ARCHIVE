...
public enum FoodType {
	 ...
	 */
	GoldenApple(Material.GOLDEN_APPLE, 20, 100, 10, 24f), Cookie(Material.COOKIE, 2, 5, 1, .2f),
	/*
	 ...
	 */
	Melon(Material.MELON, 4, 10, 4, 3f), CookedFish(Material.COOKED_FISH, 3, 10, 5, 6f);
	...
	private FoodType(Material item, int healAmount, int staminaCost, int fullnessAmount, float saturation) {
		this.item = item;
