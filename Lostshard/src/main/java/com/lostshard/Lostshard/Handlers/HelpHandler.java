		...
		if (split.length < 1) {
			if (sender instanceof Player) {
				...
				bookMeta.addPage(ChatColor.GOLD + "" + ChatColor.BOLD
				        ...
				        + ChatColor.DARK_PURPLE + "   - Force Field, Auto Eat and Pvp Mods\n\n");
				 
				//section 2 page 2
				bookMeta.addPage(ChatColor.DARK_PURPLE + "If you have any questions do not be afraid to ask one of the admins; \n"
				+ ChatColor.GOLD + "- The_Defman \n"
				...
				bookMeta.addPage(ChatColor.GOLD + "" + ChatColor.BOLD
				        ...
				        + "You can trade gold ingots at any bank using the command"
				        + ChatColor.GOLD + "/tradegold (Amount) \n"
				        + ChatColor.DARK_PURPLE
				...
				bookMeta.addPage(ChatColor.GOLD + "" + ChatColor.BOLD
				        ...
				        + ChatColor.DARK_PURPLE + "Your first plot will cost you 1000 gold Coins and 1 diamond \n\n" + ChatColor.DARK_PURPLE + "You can use the command" + ChatColor.GOLD + "/plot survey" + ChatColor.DARK_PURPLE + "to see what other player's plots are near you.\n");
				 
				//section 3 page 2
				 
				bookMeta.addPage(ChatColor.DARK_PURPLE + "Plots also have taxes. These are taken daily from your plots gold coin balance. The tax is based on the radius of your plot multiplied by 5 gold coins.\n" + ChatColor.GOLD
				                 + "    Plot Radius = 10 \n"
				                 + "    10 x 5 gold coins = 50 gold coins per day \n");
				 
				//section 3 page 3
				bookMeta.addPage(ChatColor.DARK_PURPLE + "In order to change the gold coin balance of your plot you can use the commands" + ChatColor.GOLD + "/plot desposit (Amount)" + ChatColor.DARK_PURPLE + " &" + ChatColor.GOLD + " /plot withdraw (amount) \n");
				                 
				//section 4 page 3
				bookMeta.addPage(ChatColor.DARK_PURPLE + "The dungeon upgrade" +ChatColor.GOLD + "(/plot upgrade dungeon)" + ChatColor.DARK_PURPLE + " costs 10,000 gold coins and allows monsters to spawn in the plot. The town upgrade" + ChatColor.GOLD + "(/plot upgrade town)" + ChatColor.DARK_PURPLE + " costs 100,000 gold coins and allows players to set their spawns in beds in the plot");
				...
				//section 5 page 3
				bookMeta.addPage(ChatColor.DARK_PURPLE + "You can level one skill up to level 50 and delete other skills with the command " + ChatColor.GOLD + "/resetallskills (skill name) \n");
				 
				//section 5 page 4 blades
				bookMeta.addPage(ChatColor.GOLD + "Blades\n" + ChatColor.DARK_PURPLE + "The higher this skill is the more damage you will do with a sword and the more likely it is to cause an opponent to bleed\n"
				                + ChatColor.DARK_PURPLE + "Bleeding causes small amounts of damage to be dealt periodically after the initial attack \n");
				...
				bookMeta.addPage(ChatColor.GOLD + "BlackSmithing\n" + ChatColor.DARK_PURPLE + "This skill allows you to repair and enhance items and armor using raw materials\n"
				                + ChatColor.DARK_PURPLE + "Ex   Repair tools and armor with the command" + ChatColor.GOLD + "/repair \n"
				                + ChatColor.DARK_PURPLE + "     Enchant tools and armor with the command" + ChatColor.GOLD + "/enhance \n\n");
				//section 5 page 9 blacksmiting 2
				bookMeta.addPage(ChatColor.DARK_PURPLE + "     Cobblestone repairs/enhances Chain armor and stone tools (level 0-25)\n"
				                + ChatColor.DARK_PURPLE + "     Iron ingots repairs/enhances Iron armor and tools (level 25-50)\n"
				                + ChatColor.DARK_PURPLE + "     Gold ingots repairs/enhances Gold armor and tools (Level 50-75)\n"
				                + ChatColor.DARK_PURPLE + "     Diamonds repairs/enhances Diamond armor and tools (Level 75-100)\n");
				...
				bookMeta.addPage(ChatColor.GOLD + "" + ChatColor.BOLD
				        + "Magic\n\n" + ChatColor.DARK_PURPLE + "When you kill a monster they may randomly drop a scroll\n"
				                 + ChatColor.DARK_PURPLE + "These scrolls can be used to cast spells using the command" + ChatColor.GOLD + "/scrolls use (scroll name) \n");
				                 
				//section 7 page 2
				bookMeta.addPage(ChatColor.DARK_PURPLE + "Alternatively, you can put them in your spellbook by typing" + ChatColor.GOLD + "/scrolls" + ChatColor.DARK_PURPLE + "and clicking on the available scrolls\n");
				 
				//section 7 page 3
				bookMeta.addPage(ChatColor.DARK_PURPLE + "This allows you to cast spells with the command" + ChatColor.GOLD + "/cast (spell name)" + ChatColor.DARK_PURPLE + "or make a wand with the command" + ChatColor.GOLD + "/bind (spell name)" + ChatColor.DARK_PURPLE + "and a stick");
				 
				//section 7 page 4
				bookMeta.addPage(ChatColor.DARK_PURPLE + "Casting a spell will use reagents such as feathers, string or redstone\n"
				...
				//section 7 page 5
				bookMeta.addPage(ChatColor.DARK_PURPLE + "you can determine what level and reagents a spell requires with the command" + ChatColor.GOLD + "/spellbook page (numbers 1-8)\n");
				...
				//section 8 page 2                
				bookMeta.addPage(ChatColor.DARK_PURPLE + "if you kill 5 or more players you will be marked as a murder \n"
				...
				//section 8 page 3
				bookMeta.addPage(ChatColor.DARK_PURPLE + "the only way to eliminate these murder counts is through the shrine of atonement\n\n"
				                + ChatColor.DARK_PURPLE + "You can see the moral standing of any player with the command " + ChatColor.GOLD + "/whois (Player) \n");
				                 
				//section 9 page 1    
				bookMeta.addPage(ChatColor.GOLD + "" + ChatColor.BOLD
				        + "Chat\n\n" + ChatColor.DARK_PURPLE + "Theres are different forms of communication on lost shard\n"
				                + ChatColor.DARK_PURPLE + "You may select your perferred method out of the following commands...\n");
				//section 9 page 2
				...
				bookMeta.addPage(ChatColor.DARK_PURPLE + "You can also personally message players with the command " + ChatColor.GOLD + "/msg (player) (message)" + ChatColor.DARK_PURPLE + " and reply to messages with the command " + ChatColor.GOLD + "/r (message) \n");
				...
				//section 10 page 2
				bookMeta.addPage(ChatColor.DARK_PURPLE + "A party can be created by inviting players with the command " + ChatColor.GOLD + "/party invite (player) \n\n"
				                + ChatColor.DARK_PURPLE + "To create a clan you must use the command " + ChatColor.GOLD + "/clan create (Clan Name) \n"
				...
				//section 10 page 3
				bookMeta.addPage(ChatColor.DARK_PURPLE + "Players can be invited to a clan by the owner or leaders and promoted to a leader by the owner"
				                + ChatColor.DARK_PURPLE + "Players are invited and promoted in the clan with the commands " + ChatColor.GOLD + "/clan invite (player)" + ChatColor.DARK_PURPLE + " and " + ChatColor.GOLD + "/clan promote (player)" + ChatColor.DARK_PURPLE + ", respectively \n");
				...
				//section 11 page 3
				bookMeta.addPage(ChatColor.DARK_PURPLE + "Other Miscalaneous commands include" + ChatColor.GOLD + "/kill" + ChatColor.DARK_PURPLE + "," + ChatColor.GOLD + "/help" + ChatColor.DARK_PURPLE + "," + ChatColor.GOLD + "/rules" + ChatColor.DARK_PURPLE + "and" + ChatColor.GOLD + "/spawn" + ChatColor.DARK_PURPLE + "(returns you to spawn and is only usable once per house) \n");
				                 
				//section 12 page 1
				 
				bookMeta.addPage (ChatColor.DARK_PURPLE + "Enjoy the server and remember... \n\n\n\n\n"
				+ ChatColor.BLACK + "TRUST NO ONE");
